...
"")
        ...
        icon=QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/new_entry_icon.png"),
                       QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.entry_btn.setIcon(icon)
        self.entry_btn.setIconSize(QtCore.QSize(50, 50))
        self.entry_btn.setToolButtonStyle(
        ...
        icon1=QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons8-ledger-67.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.udhari_btn.setIcon(icon1)
        self.udhari_btn.setIconSize(QtCore.QSize(50, 50))
        self.udhari_btn.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon2=QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/labour_icon.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.labour_btn.setIcon(icon2)
        self.labour_btn.setIconSize(QtCore.QSize(50, 50))
        self.labour_btn.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon3=QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/copywriting.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.record_btn.setIcon(icon3)
        self.record_btn.setIconSize(QtCore.QSize(50, 50))
        self.record_btn.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon4=QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/icons8-stock-64.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.stock_btn.setIcon(icon4)
        self.stock_btn.setIconSize(QtCore.QSize(50, 50))
        self.stock_btn.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        ...
        icon5=QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/other.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.others_btn.setIcon(icon5)
        self.others_btn.setIconSize(QtCore.QSize(50, 50))
        self.others_btn.setToolButtonStyle(
            QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
...
"}")
        ...
        icon6=QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons8-setting-64.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7=QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons8-admin-40.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.date_label.setLayoutDirection(
        ...
        self.time_label.setLayoutDirection(
            QtCore.Qt.LayoutDirection.LeftToRight)
